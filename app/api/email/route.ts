...
export async function POST(req: Request) {
  ...
  try {
    ...
    const { to, amount, name, productNamesString, addressString } = body;
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                  <tr>
                                    <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;" align="center">
                                      ...
                                      <img align="center" border="0" src="https://i.postimg.cc/qqfSh6wR/image-3.png"
                            ...
                            <tr>
                              <td class="v-container-padding-padding"
                                ...
                                <h1 class="v-text-align v-font-size"
                                  style="margin: 0px; color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Montserrat',sans-serif; font-size: 28px; font-weight: 400;">
                              ...
                              <td class="v-container-padding-padding"
                                ...
                                <div class="v-text-align v-font-size"
                                  ...
                                  <p style="font-size: 14px; line-height: 140%;"><span
                                      style="font-size: 18px; line-height: 25.2px;" class="date-obj">${formattedDate}</span></p>
                                </div>
                            ...
                            <tr>
                              <td class="v-container-padding-padding"
                                ...
                                <div class="v-text-align v-font-size"
                                  ...
                                  <h1>Thank You for Your Cubix Store Order!</h1>
  
                                  <p>Dear ${name},</p>
  
                                  <p>Thank you for choosing Cubix Store for your recent purchase! We appreciate your trust
                                    in us.</p>
  
                                  <p>Your order is important to us, and we are working diligently to process and ship it
                                    as soon as possible. We value your business and are committed to providing you with a
                                    seamless shopping experience.</p>
  
                                  <p>We look forward to hearing your feedback, and if you have any questions or concerns,
                                    feel free to reach out to our customer service team at [customer service email or
                                    phone number].</p>
  
                                  <p>Thank you again for choosing Cubix Store!</p>
  
                                  <p class="signature">Best regards,<br>Kaustabh Mahanta<br>Cubix Store Team</p>
                                  </p>
                                  </p>
                                </div>
                          ...
                          <tbody>
                            <tr>
                              <td class="v-container-padding-padding"
                                ...
                                <!--[if mso]><table width="100%"><tr><td><![endif]-->
                                <h1 class="v-text-align v-font-size"
                                  style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-family: 'Rubik',sans-serif; font-size: 18px; font-weight: 400;padding: 0px 30px 20px;">
                                  <span style="font-weight: bold; font-size: 25px;">Items Ordered:</span> <br>
                                  <strong>${productNamesString}</strong>
                                </h1>
                                <!--[if mso]></td></tr></table><![endif]-->
                      ...
                      <div
                        ...
                        <table style="font-family:'Rubik',sans-serif;" role="presentation" cellpadding="0" cellspacing="0"
                          ...
                          <tbody>
                            <tr>
                              <td class="v-container-padding-padding"
                                style="overflow-wrap:break-word;word-break:break-word;padding:15px 10px;font-family:'Rubik',sans-serif;"
                                align="left">
  
                                <!--[if mso]><table width="100%"><tr><td><![endif]-->
                                <h1 class="v-text-align v-font-size"
                                  style="margin: 0px; color: #ba372a; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Rubik',sans-serif; font-size: 18px; font-weight: 400;">
                  ...
                  <div class="u-col u-col-100"
                    ...
                    <div
                      ...
                      <div
                          ...
                          <tbody>
                            <tr>
                              <td class="v-container-padding-padding"
                                ...
                                <!--[if mso]><table width="100%"><tr><td><![endif]-->
                                <h1 class="v-text-align v-font-size"
                                  style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Rubik',sans-serif; font-size: 18px; font-weight: 400;">
                        ...
                        <table id="u_content_text_10" style="font-family:'Rubik',sans-serif;" role="presentation"
                          cellpadding="0" cellspacing="0" width="100%" border="0">
                          <tbody>
                            <tr>
                              <td class="v-container-padding-padding"
                                ...
                                <div class="v-text-align v-font-size"
                                  ...
                                  <p style="font-size: 14px; line-height: 140%;">Lorem ipsum dolor sit amet, consectetuer
                        ...
                        <table id="u_content_button_1" style="font-family:'Rubik',sans-serif;" role="presentation"
                          cellpadding="0" cellspacing="0" width="100%" border="0">
                          <tbody>
                            <tr>
                              <td class="v-container-padding-padding"
